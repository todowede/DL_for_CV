...
ap.add_argument("-o", "--dataset", required=True,
...
# partition data into training and testing splits using 75%
# for training anf 25% for test
...
# traiing the ShallowNet network
...
print("[INFO] serializing netowrk...")
