...
class TrainingMonitor(BaseLogger):
    def __init__(self, figPath, jsonPath=None, startAt=0):
        ...
        # to the JSON serialized file and the starting epoch
    ...
    def on_train_begin(self, logs={}):
        ...
        # if the JSOn history path exists, load the training hist
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        # construct plot
        # ensure at least 2 epochs have passed b4 plotting
        # epochs starts at zero
